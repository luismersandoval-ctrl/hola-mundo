...
ODONTOLOGY_TERMS = (
    "ODONTOLOG", "DENTAL", "DIENTE", "DIENTES", "DENTARI",
    "MAXILAR SUPERIOR", "MAXILAR INFERIOR", "MAXILARES SUPERIOR E INFERIOR",
)
ODONTOLOGY_EXCLUSIONS = (
    "HUESO TEMPORAL", "NASAL", "QUISTE TUMORAL",
    "QUISTES TUMORALES", "DRENAJE DE QUISTE", "DRENAJE DE QUISTES",
)
PRIORITY_CODES = {
    "890203", "890204", "890403", "870112", "870113", "870114", "870440",
    "870450", "870451", "870452", "870453", "870454", "870455", "870456",
}
...
def main(source, destination):
    ...
    with destination.open("w", encoding="utf-8", newline="") as output:
        ...
        for row in rows:
            ...
            odontological = any(term in normalized for term in ODONTOLOGY_TERMS) and not any(
                term in normalized for term in ODONTOLOGY_EXCLUSIONS
            )
