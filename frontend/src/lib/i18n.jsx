...
const translations = {
  es: {
    ...
    menu:{agenda:'Agenda',reminders:'Recordatorios',history:'Historia Clínica',odontogram:'Odontograma',periodontogram:'Periodontograma',payments:'Pagos y Caja',inventory:'Inventario',reports:'Reportes',dashboard:'Dashboard',integrations:'Integraciones',team:'Equipo'},
  ...
  en: {
    ...
    menu:{agenda:'Schedule',reminders:'Reminders',history:'Clinical History',odontogram:'Odontogram',periodontogram:'Periodontogram',payments:'Payments & Cash',inventory:'Inventory',reports:'Reports',dashboard:'Dashboard',integrations:'Integrations',team:'Team'},
